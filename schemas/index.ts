...
const roleOptions = [
    ...
    { key: 'Account Sales Representative', value: 'Account Sales Representative'},
    { key: 'Database Management Permissions', value: 'Database Management Permissions'},
]
...
export const businessIdentitySchema = Yup.object().shape(
    {
        ...
        business_serial_number: Yup.string().required("Business Serial Number is required!."),
    }
)
